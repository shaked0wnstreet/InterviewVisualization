...
class CirvrStudio extends Component{
    ...
    render(){
        ...
        <Layout style={{height: "100%", margin:0}}>
            <NavBar ></NavBar>
            <Content className="root"  style={{minHeight: window.innerHeight, width:"100%", padding: "10px",  marginBottom: "0px", color:"black"}}>
                <BackTop/>
                <Row className="sticky" align="middle" gutter={[8,8]}  style={{background: "white", width: "100%", zIndex:"1", color:"black"}}>
                    <Col span={4} xs={24} sm={24} md={5} lg={4}>
                        <PageHeader
                        className="site-page-header"
                        onBack={this.handleRedirect}
                        title="Back"
                        subTitle=""/>
                    </Col>
                    <Col justify="center" align="middle" span={4} xs={24} sm={24} md={6} lg={4}  style={{background: "white"}}>
                        <Button style={{width: "155px"}} type="primary" icon={<SaveOutlined />} onClick={this.handleSubmit}> Save </Button>
                    </Col>
                    <Col justify="center" align="middle"  span={4} xs={24} sm={24} md={12} lg={4}>
                        <Button  style={{width: "155px"}} onClick={this.downloadTxtFile} type="primary" icon={<DownloadOutlined/>}> Download JSON </Button>
                    </Col>
                    <Col justify="center" align="middle"  span={4} xs={24} sm={24} md={12} lg={4}>
                        <Button  style={{width: "155px"}} onClick={this.togglePanel} type="primary" icon={this.state.jsonOpen? <RightOutlined/>: <LeftOutlined />}> {this.state.jsonOpen? "Collapse JSON": "Open JSON"} </Button>
                    </Col>
                    <Col justify="center" align="middle"  span={4} xs={24} sm={24} md={12} lg={4}>
                        <Button  style={{width: "155px"}} type="primary" icon={<DotChartOutlined />} onClick={this.graphViewToggle}> Button View </Button>
                    </Col>
                    <Col span={24} >
                       {/* <h4>{this.state.jsonData.title}</h4>*/}
                ...
                <Col 
                style={this.state.jsonOpen? {paddingLeft:"0px", paddingRight:"0px"}:{ paddingLeft:"250px", paddingRight:"250px"}} 
                span={this.state.jsonOpen?12: 16} 
                xs={this.state.jsonOpen?24:0} 
                sm={this.state.jsonOpen?24:0} 
                md={this.state.jsonOpen?24:0} 
                lg={this.state.jsonOpen?12: 24} >
                    ...
                    <Col span={12} 
                    xs={this.state.jsonOpen?12:0} 
                    sm={this.state.jsonOpen?24:0} 
                    md={this.state.jsonOpen?24:0} 
                    lg={this.state.jsonOpen?12:0} 
            ...
            <Footer style={{color: "white", backgroundColor: "black"}} >
            Robotics and Autonomous Systems Lab @ Vanderbilt University 2020
